...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var introSlidesAmount = document.querySelectorAll(".intro-slider__slide").length;
  ...
  introSlider.on("slideChange", function () {
    setIntroFraction(introFractCurrent, introFractTotal, introSlidesAmount, introSlider.realIndex);
  });
  ...
  var prodThumbsAmount = document.querySelectorAll(".prod-thumb__item").length - 1;
  var prodMainAmount = document.querySelectorAll(".prod-main__item").length - 1;
  var prodSliderThumbs = new Swiper(".producers-slider-thumbs", {
    spaceBetween: 90,
    centeredSlides: true,
    slidesPerView: "auto",
  ...
  var prodSliderMain = new Swiper(".producers-slider-main", {
    loop: true,
  ...
  prodSliderThumbs.controller.control = prodSliderMain; // popular slider

  var popSliders = document.querySelectorAll(".popular-tab__slider");
  popSliders.forEach(function (el) {
    new Swiper(el, {
      spaceBetween: 21,
      slidesPerView: 4,
      navigation: {
  ...
  var clientsThumbsAmount = document.querySelectorAll(".clients-thumb__item").length - 1;
  var clientsMainAmount = document.querySelectorAll(".clients-main__item").length - 1;
  var clientsSliderThumbs = new Swiper(".clients-slider-thumbs", {
    spaceBetween: 10,
    centeredSlides: true,
    slidesPerView: "auto",
    slideToClickedSlide: true,
  ...
  var clientsSliderMain = new Swiper(".clients-slider-main", {
    loop: true,
    loopedSlides: prodMainAmount,
    pagination: {
      el: ".swiper-pagination",
  ...
  var aboutBlogSlider = new Swiper(".about-blog__slider", {
    direction: "vertical",
    slidesPerView: 3.4,
    mousewheel: true,
    grabCursor: true,
  ...
  var productSliderMain = new Swiper(".product-slider-main", {
    effect: "fade",
    fadeEffect: {
      crossFade: true
    },
  ...
  var accessoriesSlider = new Swiper(".product-acc__slider", {
    slidesPerView: 4,
    spaceBetween: 20,
    navigation: {
      nextEl: ".slider-button-next",
    ...
    _createClass(ItcTabs, [{
      ...
      value: function _init() {
        ...
        this._elButtons.forEach(function (el, index) {
          ...
          _this3._elPanes[index].setAttribute("role", "tabpanel");
        });
      }
    }, {
      key: "show",
  ...
  var productNavs = document.querySelector(".product-info__navs");
  var initPosElem = productNavs && productNavs.getBoundingClientRect().top + window.pageYOffset;
  var productNavslinks = document.querySelectorAll(".product-info__navs-btn"),
      productSections = document.querySelectorAll(".product-section");

  function fixedProductNavs() {
    var curPosElem = productNavs.getBoundingClientRect().top;
  ...
  function setProdActiveNavEl() {
    ...
    productSections.forEach(function (el, index) {
      if (scrollDistance >= el.offsetTop - 250) {
        productNavslinks.forEach(function (elem) {
  ...
  var prodAccTitle = document.querySelectorAll(".product-section__heading"),
  ...
  var filterPrices = document.querySelectorAll(".filter-price__input");
  filterPrices.forEach(function (el) {
    el.addEventListener("input", function () {
      el.value = el.value.replace(/[^0-9]/g, "");
      el.value = Number(el.value).toLocaleString();
    });
  });
  var filterTitle = document.querySelectorAll(".filter-item__heading"),
  ...
  var catalogHorBtn = document.getElementById("catalog-hor");
  var catalogVertBtn = document.getElementById("catalog-vert");
  var catalogContent = document.querySelector(".catalog-content");
  var filterHeading = document.querySelector(".filter-heading");
...
var header = document.querySelector(".headerMob");
var lastScroll = 0;
...
window.addEventListener("scroll", throttle(validateHeader, 20)); //header desctop scroll

var headerDesctop = document.querySelector(".slickyContainer");
var lastScrollDesctop = 0;

var throttleFunction = function throttleFunction(func) {
  var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 20;
  var lastTime = 0;
  return function () {
    var now = new Date();
...
var validateHeaderFunction = function validateHeaderFunction() {
  var windowY = window.scrollY;
  var windowH = 430;
...
window.addEventListener("scroll", throttleFunction(validateHeaderFunction, 20)); //brandsSecondLevel tabs 

var tabsBtn = document.querySelectorAll(".controlTitle");
var tabsItems = document.querySelectorAll(".radioCotainer");
